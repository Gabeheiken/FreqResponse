...
def offlineEventDetection(archiveFreq):
    ...
    # ============================= Parameters =================================
    slew_window = 170       # window for calculating slew
    point_separation = 3        # gap between two slew points to be compared
    fore_point = point_separation - 1
    slew_diff_thresh = 0.00000348         # slew diff between two slew points separated by "point_separation"
    series_over = 5  # the number of times in a row that slew_diff_thresh is exceeded
    event_thresh = 0.00001747       # deviation of slew at the point when series over is reached
